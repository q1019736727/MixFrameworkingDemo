...
typedef void(^TMTextViewHandler)(TMTextView *textView);
 ...
 */
- (void)addTextDidChangeHandler:(TMTextViewHandler)eventHandler;

/**
 设定达到最大长度Block回调. (切记弱化引用, 以免造成内存泄露.)
 */
- (void)addTextLengthDidMaxHandler:(TMTextViewHandler)maxHandler;
