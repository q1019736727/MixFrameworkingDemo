...
@protocol TMPageControlDelegate;
...
/**
 * Delegate for TMPageControl
 */
@property(nonatomic,assign) id<TMPageControlDelegate> delegate;
...
@optional
- (void)TMPageControl:(TMPageControl *)pageControl didSelectPageAtIndex:(NSInteger)index;
