...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CYCommonSDK/CYCommonSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TMWebViewJavascriptBridge/TMWebViewJavascriptBridge.framework"
